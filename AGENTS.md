...
- Android Prototype: A minimal native Android app lives under /android to validate lock-screen style ongoing notifications via a foreground service, plus an AppWidget for live score display.
